...
/**
 * REST controller for managing {@link com.vgambier.mealplan.domain.Ingredient}.
 */
@RestController
@RequestMapping("/api")
public class IngredientResource {
    ...
    public ResponseEntity<IngredientDTO> partialUpdateIngredient(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ingredientDTO.getId().toString())
        );
    }
